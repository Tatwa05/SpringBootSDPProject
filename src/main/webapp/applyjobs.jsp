    ...
    <div class="main-content">
        ...
        <section class="jobs-section">
            ...
            <section class="jobs-grid">
                ...
                <c:if test="${job.status != 'Inactive' && job.status!= 'Blocked' }">
                <section class="job-card">
                    ...
                    <section class="job-actions">
                        <button class="action-btn apply-btn" data-apply-url="/student/applyforjob?id=${job.id}">Apply Now</button>
                        <button class="action-btn watchlist-btn" onclick="window.location.href='/student/savejob?id=${job.id}'">
                            <i class="far fa-bookmark"></i>
                            Save
                        </button>
                        <button class="explore-btn" onclick="window.location.href='/student/jobdetails?id=${job.id}'">
