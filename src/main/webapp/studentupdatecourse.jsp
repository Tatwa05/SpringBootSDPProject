...
<script src="${pageContext.request.contextPath}/JavaScript/studentdashboard.js"></script>
    ...
    <div class="education-form-container">
        <h2 class="form-title">Educational Details</h2>
        <form action="updateeducationdetails" method="post">
            <input type="hidden" name="sid" value="<%= s.getId() %>">
            
            <div class="form-group">
                <label for="degree">Degree Level*</label>
                <select class="form-control" id="degree" name="sdegree" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="major" name="smajor" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="specialization" name="sspec" required>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="cgpa" name="scgpa" step="0.01" min="0" max="10" required>
            </div>

            <div class="form-row">
                <div class="form-group">
                    <label for="startdate">Start Date*</label>
                    <input type="date" class="form-control" id="startdate" name="sstart" required>
                </div>

                <div class="form-group">
                    <label for="enddate">End Date*</label>
                    <input type="date" class="form-control" id="enddate" name="send" required>
                </div>
            </div>

            <button type="submit" class="submit-btn">Save Educational Details</button>
        </form>
    </div>
</section>
    </div>
